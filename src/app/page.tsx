      ...
      <main className="pt-[72px]">
        ...
        <section className="relative overflow-hidden py-24 md:py-36">
          ...
          <div className="absolute inset-0 opacity-[0.05]">
            <div className="absolute top-0 right-0 w-1/2 h-1/2 bg-[hsl(var(--jwc-navy))] blur-[140px] rounded-full"></div>
            <div className="absolute bottom-0 left-0 w-1/3 h-1/3 bg-black blur-[120px] rounded-full"></div>
          </div>
          <div className="container mx-auto px-8 relative z-10">
            <div className="grid md:grid-cols-2 gap-16 items-center">
              {/* Hero Content */}
              <div className="space-y-6">
                <div className="inline-flex items-center gap-2 bg-gradient-to-r from-[hsl(var(--jwc-navy))]/15 to-transparent px-6 py-3 rounded-full border border-[hsl(var(--jwc-navy))]/20 backdrop-blur-sm">
                  <div className="w-2 h-2 rounded-full bg-[hsl(var(--jwc-navy))] animate-pulse"></div>
                  <span className="text-sm font-medium tracking-wide text-[hsl(var(--jwc-navy))]">
                    Premium Collection
                  </span>
                  <span className="text-[hsl(var(--jwc-navy))]">•</span>
                  <span className="text-sm font-medium text-[hsl(var(--jwc-black))]">
                ...
                <div className="w-20 h-1 bg-[hsl(var(--jwc-navy))] rounded-full"></div>
                ...
                <div className="grid grid-cols-3 gap-6 p-10 bg-white/70 backdrop-blur-xl rounded-3xl border border-[hsl(var(--jwc-border))]/60 shadow-luxury">
                  ...
                  <div className="text-center space-y-2 border-x border-[hsl(var(--jwc-border))]/40">
                  ...
                  <div className="text-center space-y-2">
                    <div className="text-5xl font-bold text-[hsl(var(--jwc-navy))] tracking-tight">+22%</div>
                    <div className="text-xs uppercase tracking-wider text-[hsl(var(--muted-foreground))] font-semibold">
                      Efficiency
                    </div>
                  </div>
                ...
                <div className="flex flex-wrap gap-4 pt-4">
                  <Link
                    href="/quote"
                    className="no-underline group relative bg-gradient-to-r from-[hsl(var(--jwc-navy))] to-[hsl(var(--jwc-navy-dark))] text-white px-12 py-4.5 rounded-2xl font-semibold hover:shadow-navy transition-all duration-400 hover:-translate-y-1.5 inline-flex items-center gap-3 overflow-hidden"
                  >
                    <span className="relative z-10">Start Your Transformation</span>
                    <ArrowRight size={20} className="relative z-10 group-hover:translate-x-1.5 transition-transform duration-300" />
                    <div className="absolute inset-0 bg-[hsl(var(--jwc-navy-dark))] opacity-0 group-hover:opacity-100 transition-opacity duration-400"></div>
                  </Link>
                  <Link
                    href="/specifications"
                    className="no-underline bg-white/85 backdrop-blur-md text-[hsl(var(--jwc-navy))] px-12 py-4.5 rounded-2xl font-semibold border border-[hsl(var(--jwc-navy))]/15 hover:border-[hsl(var(--jwc-navy))] hover:bg-white transition-all duration-400 hover:-translate-y-1.5 hover:shadow-lg"
                  >
                    Technical Details
                  </Link>
                </div>
              ...
              <div className="relative aspect-[4/3] rounded-2xl overflow-hidden shadow-luxury luxury-hover">
                <div className="absolute inset-0 bg-gradient-to-br from-[hsl(var(--jwc-white))] to-[hsl(var(--jwc-white))] flex items-center justify-center p-8 border border-[hsl(var(--jwc-border))]">
        ...
        <section className="py-28 bg-gradient-to-b from-white via-[hsl(var(--jwc-white))] to-[hsl(var(--jwc-white))]">
          <div className="container mx-auto px-8">
            <div className="text-center mb-20 space-y-5">
              <div className="inline-block">
                <h2 className="mb-0">Elevate Your Everyday Living</h2>
                <div className="w-32 h-1.5 bg-gradient-to-r from-[hsl(var(--jwc-navy))] to-[hsl(var(--jwc-navy))] rounded-full mx-auto mt-5"></div>
              </div>
            ...
            <div className="grid md:grid-cols-3 gap-10">
              <div className="group bg-white/90 backdrop-blur-md p-12 rounded-3xl border border-[hsl(var(--jwc-border))]/50 shadow-lg hover:shadow-luxury transition-all duration-500 hover:-translate-y-3 relative overflow-hidden">
                <div className="absolute top-0 right-0 w-32 h-32 bg-gradient-to-br from-[hsl(var(--jwc-navy))]/10 to-transparent rounded-full blur-2xl -mr-16 -mt-16 group-hover:scale-150 transition-transform duration-500"></div>
                <div className="relative z-10">
                  ...
                  <ul className="space-y-3 text-sm">
                    <li className="flex items-center gap-3 group/item">
                      <CheckCircle2 size={18} className="text-[hsl(var(--jwc-navy))] flex-shrink-0" />
              ...
              <div className="group bg-white/90 backdrop-blur-md p-12 rounded-3xl border border-[hsl(var(--jwc-border))]/50 shadow-lg hover:shadow-luxury transition-all duration-500 hover:-translate-y-3 relative overflow-hidden">
                <div className="absolute top-0 right-0 w-32 h-32 bg-gradient-to-br from-[hsl(var(--jwc-navy))]/10 to-transparent rounded-full blur-2xl -mr-16 -mt-16 group-hover:scale-150 transition-transform duration-500"></div>
                <div className="relative z-10">
                  <div className="w-16 h-16 bg-gradient-to-br from-[hsl(var(--jwc-navy))] to-[hsl(var(--jwc-navy-dark))] rounded-2xl flex items-center justify-center mb-6 shadow-lg group-hover:scale-110 transition-transform duration-400">
              ...
              <div className="group bg-white/90 backdrop-blur-md p-12 rounded-3xl border border-[hsl(var(--jwc-border))]/50 shadow-lg hover:shadow-luxury transition-all duration-500 hover:-translate-y-3 relative overflow-hidden">
                <div className="absolute top-0 right-0 w-32 h-32 bg-gradient-to-br from-black/10 to-transparent rounded-full blur-2xl -mr-16 -mt-16 group-hover:scale-150 transition-transform duration-500"></div>
                <div className="relative z-10">
                  <div className="w-16 h-16 bg-gradient-to-br from-black to-[hsl(var(--jwc-black))] rounded-2xl flex items-center justify-center mb-6 shadow-lg group-hover:scale-110 transition-transform duration-400">
                  ...
                  <ul className="space-y-3 text-sm">
                    <li className="flex items-center gap-3 group/item">
                      <CheckCircle2 size={18} className="text-[hsl(var(--jwc-black))] flex-shrink-0" />
          ...
          <div className="container mx-auto px-8">
            <div className="text-center mb-16 space-y-4">
              <div className="inline-block">
                ...
                <div className="w-32 h-1 bg-gradient-to-r from-[hsl(var(--jwc-navy))] to-[hsl(var(--jwc-navy))] rounded-full mx-auto mt-4"></div>
              </div>
              <p className="text-lg text-[hsl(var(--muted-foreground))] max-w-2xl mx-auto leading-relaxed">
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center mb-20">
              <div className="space-y-6">
                <div className="inline-flex items-center gap-2 bg-gradient-to-r from-[hsl(var(--jwc-navy))]/15 to-transparent px-4 py-2 rounded-full border border-[hsl(var(--jwc-navy))]/20">
                  <Sparkles className="w-4 h-4 text-[hsl(var(--jwc-navy))]" />
                ...
                <div className="space-y-3">
                  <div className="flex items-start gap-3">
                    <CheckCircle2 className="w-5 h-5 text-[hsl(var(--jwc-navy))] flex-shrink-0 mt-1" />
                    <div>
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              ...
              <div className="space-y-6 order-1 md:order-2">
                <div className="inline-flex items-center gap-2 bg-gradient-to-r from-[hsl(var(--jwc-navy))]/15 to-transparent px-4 py-2 rounded-full border border-[hsl(var(--jwc-navy))]/20">
                  <Volume2 className="w-4 h-4 text-[hsl(var(--jwc-navy))]" />
        ...
        <section className="py-28 bg-gradient-to-b from-[hsl(var(--jwc-white))] via-white to-[hsl(var(--jwc-white))] relative overflow-hidden">
          <div className="absolute inset-0 opacity-[0.04]">
            <div className="absolute top-1/4 left-1/4 w-80 h-80 bg-[hsl(var(--jwc-navy))] blur-[120px] rounded-full"></div>
          </div>
          <div className="container mx-auto px-8 relative z-10">
            <div className="text-center mb-20 space-y-5">
              <div className="inline-block">
            ...
            <div className="max-w-6xl mx-auto">
              <div className="bg-white/95 backdrop-blur-xl rounded-[2rem] shadow-luxury border border-[hsl(var(--jwc-border))]/40 p-14">
                {/* Color Customization */}
                <div className="mb-16">
                  <ColorSelector />
                </div>
        ...
        <section className="py-28 bg-gradient-to-br from-[hsl(var(--jwc-navy))] via-[hsl(var(--jwc-navy-dark))] to-[hsl(var(--jwc-navy))] text-white relative overflow-hidden">
          <div className="absolute inset-0 opacity-[0.10]">
            <div className="absolute top-0 right-0 w-[500px] h-[500px] bg-[hsl(var(--jwc-navy))] blur-[160px] rounded-full"></div>
          ...
          <div className="container mx-auto px-8 relative z-10">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-10 mb-20">
              <div className="text-center group">
                <div className="mb-6 inline-block p-8 bg-white/10 backdrop-blur-md rounded-3xl border border-white/20 group-hover:border-[hsl(var(--jwc-navy))]/60 transition-all duration-400 group-hover:scale-110">
              ...
              <div className="text-center group">
                <div className="mb-6 inline-block p-8 bg-white/10 backdrop-blur-md rounded-3xl border border-white/20 group-hover:border-[hsl(var(--jwc-navy))]/60 transition-all duration-400 group-hover:scale-110">
                  <div className="text-6xl font-bold bg-gradient-to-br from-[hsl(var(--jwc-navy))] to-[hsl(var(--jwc-navy))] bg-clip-text text-transparent mb-2 tracking-tight">Class 5</div>
                </div>
              ...
              <div className="text-center group">
                <div className="mb-6 inline-block p-8 bg-white/10 backdrop-blur-md rounded-3xl border border-white/20 group-hover:border-[hsl(var(--jwc-navy))]/60 transition-all duration-400 group-hover:scale-110">
                  <div className="text-6xl font-bold bg-gradient-to-br from-[hsl(var(--jwc-navy))] to-[hsl(var(--jwc-navy))] bg-clip-text text-transparent mb-2 tracking-tight">ER 44</div>
                </div>
            ...
            <div className="text-center">
              <Link
                href="/specifications"
                className="no-underline inline-block bg-white text-[hsl(var(--jwc-navy))] px-12 py-4.5 rounded-2xl font-semibold hover:bg-[hsl(var(--jwc-navy))] hover:text-white transition-all duration-400 hover:-translate-y-1.5 hover:shadow-navy"
              >
        ...
        <section className="py-32 bg-gradient-to-br from-[hsl(var(--jwc-navy))] via-[hsl(var(--jwc-navy-dark))] to-[hsl(215_70%_20%)] text-white relative overflow-hidden">
          <div className="absolute inset-0 opacity-[0.18]">
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[900px] h-[900px] bg-[hsl(var(--jwc-navy))] blur-[220px] rounded-full animate-pulse"></div>
          </div>
          ...
          <div className="container mx-auto px-8 text-center relative z-10">
            <div className="inline-block mb-6">
              <div className="inline-flex items-center gap-2 bg-[hsl(var(--jwc-navy))]/20 backdrop-blur-sm px-6 py-2 rounded-full border border-[hsl(var(--jwc-navy))]/30 mb-8">
                <div className="w-2 h-2 rounded-full bg-[hsl(var(--jwc-navy))] animate-pulse"></div>
                <span className="text-sm font-medium text-[hsl(var(--jwc-navy))] uppercase tracking-wider">
                  Premium Windows Solution
                </span>
              </div>
            </div>
            <h2 className="mb-8 text-white max-w-3xl mx-auto">Ready to Transform Your Home?</h2>
            <div className="w-32 h-1.5 bg-gradient-to-r from-[hsl(var(--jwc-navy))] to-[hsl(var(--jwc-navy))] rounded-full mx-auto mb-10"></div>
            ...
            <div className="flex flex-wrap gap-6 justify-center mb-16">
              <Link
                href="/quote"
                className="no-underline group relative bg-white text-[hsl(var(--jwc-navy))] px-14 py-5 rounded-2xl font-bold text-lg hover:shadow-navy transition-all duration-400 hover:-translate-y-1.5 inline-flex items-center gap-3 overflow-hidden"
              >
                <span className="relative z-10">Get Your Free Quote</span>
                <ArrowRight size={22} className="relative z-10 group-hover:translate-x-1.5 transition-transform duration-300" />
                <div className="absolute inset-0 bg-[hsl(var(--jwc-navy))] opacity-0 group-hover:opacity-10 transition-opacity duration-400"></div>
              </Link>
              <Link
                href="/specifications"
                className="no-underline bg-white/10 backdrop-blur-md border border-white/30 text-white px-14 py-5 rounded-2xl font-bold text-lg hover:bg-white/20 hover:border-[hsl(var(--jwc-navy))] transition-all duration-400 hover:-translate-y-1.5"
              >
            ...
            <div className="inline-block p-6 bg-white/5 backdrop-blur-sm rounded-2xl border border-white/10">
              ...
              <div className="flex flex-wrap gap-6 justify-center text-white/80">
                <a href="tel:1-800-JWC-8500" className="no-underline hover:text-[hsl(var(--jwc-navy))] transition-colors font-medium">
                  📞 1-800-JWC-8500
                </a>
                <span className="text-white/30">•</span>
                <a href="mailto:sales@jwc.com" className="no-underline hover:text-[hsl(var(--jwc-navy))] transition-colors font-medium">
                  ✉️ sales@jwc.com
                </a>
              </div>
            </div>
